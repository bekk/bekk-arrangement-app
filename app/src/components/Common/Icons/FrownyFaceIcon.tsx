...
export const FrownyFaceIcon = (props: { className: string }) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <g clipPath="url(#clip0)">
        ...
        />
        <path
          d="M11.9999 14.3C13.7999 14.3 15.1999 15.8 15.1999 17.5L16.3999 17.5C16.3999 15 14.3999 13.1 11.9999 13.1C9.5999 13.1 7.5999 15.1 7.5999 17.5L8.7999 17.5C8.7999 15.7 10.1999 14.3 11.9999 14.3Z"
          fill="#BABABA"
        />
        <path
